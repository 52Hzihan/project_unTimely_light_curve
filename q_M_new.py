...
through parameters. The only remaining issue with the funciton is
the whole dv (ignoring peaks/freqs. within peak window function
periods/freqs.) situation. Should prob add axvfill translucent
    ...
    ***
    ...
    for id in ids:
        ...
        def create_plot():
            ...
            for i in range(len(false_alarm_levels) - 1, -1,
                           -1):  # Plot them in reverse order so the highest confidence label is
...
key_file = '/Users/zhangjingyi/Desktop/ztf_data/out/key.csv'
data_temp = '/Users/zhangjingyi/Desktop/ztf_data/light_curves/+++_r.csv'
plot_path = '/home/thaddaeus/FMU/HRL/LAH2.0/efforts/theta/q_and_per_work/q_work/best_routine_so_far/plots/***:ID:+++.png'
report_file = '/home/thaddaeus/FMU/HRL/LAH2.0/efforts/theta/q_and_per_work/q_work/best_routine_so_far/results.csv'

q_m_and_ls(key=key_file, data_temp=data_temp, dv=0.03, min_per=0.1, max_per=250,
           pti=['0.45:0.55', '0.95:1.05', '26:30'], false_alarm_levels=[0.1, 0.05, 0.01], out_type=plot_path,
